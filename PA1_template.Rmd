...
Note that these are (almost) the same values as above.  This does not appear to be an error, because if we calculate the sum of each we see that they're different:
```{r}
nrow(steps.total)
sum(steps.total[, 2])
